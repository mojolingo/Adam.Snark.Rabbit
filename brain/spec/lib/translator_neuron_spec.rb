...
describe TranslatorNeuron do
  ...
  context "requesting translation" do
    ...
    it "should handle a properly formed request" do
      ...
      interpretation = wit_response_for message_body, 'phrase_to_translate' => phrase_to_translate, 'language' => 'Portuguese'
    ...
    it "should handle an untranslateable target language" do
      ...
      interpretation = wit_response_for message_body, 'phrase_to_translate' => phrase_to_translate, 'language' => 'Afrikaans'
    ...
    it "should handle an invalid target language" do
      ...
      interpretation = wit_response_for message_body, 'phrase_to_translate' => phrase_to_translate, 'language' => 'Klingon'
